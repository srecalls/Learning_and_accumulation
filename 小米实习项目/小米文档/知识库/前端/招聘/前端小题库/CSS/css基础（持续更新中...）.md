...
![](https://xiaomi.f.mioffice.cn/space/api/file/out/F7Zr61MEOpLg7O3ypuKj1VqRyHwfQ9YYaCpzvofWIb3R54uRg6/)

> 可以结合这个例子理解z-index

> https://codepen.io/xiaomuzhu/pen/xowqjG
...
> <!-- 样式表中的CSS媒体查询 --><style>@media (max-width: 600px) {
>   .facet_sidebar {
>     display: none;
>   }}</style>
> ```
...
![](https://xiaomi.f.mioffice.cn/space/api/box/stream/download/asynccode/?code=MDBiMWIwNzQyNjc4NTkyYzUwMzk3ZmNmMWQwM2ExM2Ffb015cDlqWEppUjYxTTNFb01aU0loZ24yRzJXcG1sSTNfVG9rZW46Ym94azRaMDc5amNUVTNDbWJXY1JzbEVUSkpjXzE3MDE0MDk5NDY6MTcwMTQxMzU0Nl9WNA)
...
> 具体用法移步阮一峰的[flex语法](http://www.ruanyifeng.com/blog/2015/07/flex-grammar.html)、[flex实战](http://www.ruanyifeng.com/blog/2015/07/flex-examples.html)，讲得非常通俗易懂。
